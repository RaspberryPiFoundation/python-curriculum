...
1. Open a new code window (From the File menu) and write the following:  
    ...
    ```
2. Save your program as turtles.py and choose Run -> Run Module. See how the turtle moved forward 100 pixels? The turtle has a pen attached, and draws lines as it moves around the screen.  
