...
What's your favourite colour? You can change the colour of the lines using the function `color` (Python uses American spellings), and you can also change the pen size using `pensize`:
...
You can also specify colours in __hex__ like we did in CSS. Instead of using `color(red)` you could use hex `color("#FF0000")`.
